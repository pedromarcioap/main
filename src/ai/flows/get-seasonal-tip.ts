...
const GetSeasonalTipOutputSchema = z.object({
  tip: z.string().describe('Uma dica de jardinagem sazonal curta e acionável.'),
});
...
const prompt = ai.definePrompt({
  ...
  prompt: `Você é um botânico especialista. Forneça uma dica de jardinagem curta e acionável em português do Brasil para a seguinte estação: {{{season}}}. A dica deve ser geral e útil para proprietários de plantas de interior.`,
});
